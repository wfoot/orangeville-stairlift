...
3. **Domain** — built for `orangevillestairlift.ca`. If that changes, update each page's `<link rel="canonical">` and the schema `url`/`image` fields.
